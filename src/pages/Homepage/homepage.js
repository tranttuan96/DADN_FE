        ...
        <div className="showContent">
          <div className="chose__farm">
            ...
            <select
              ...
              onChange={handleChangeSelectFarm}
            >
              <option value={farm} defaultValue hidden>
                {farm}
              </option>
              {farms.map((farm, i) => {
                return <option value={farms[i].name}>{farms[i].name}</option>;
          ...
          <div className="content">
            <div className="item">
              ...
              <div className="parameterName">Thời gian cập nhật</div>
              <div className="detail">{parameter.time}</div>
            </div>
            <div className="item">
              <div className="icon">
                <img src={"images/humidity-icon.png"} />
              </div>
              <div className="parameterName">Độ ẩm</div>
              <div className="detail">{parameter.humidity}</div>
            </div>
            <div className="item">
              <div className="icon">
